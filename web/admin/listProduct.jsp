			...
			<form action="admin_product_add" method="post" id="addForm">
				<table class="addTable">
					...
					<tr>
						<td>原价格</td>
						<td>
							<input type="text" name="originalPrice" id="originalPrice" value="99" class="form-control">
						</td>
					</tr>
					<tr>
						<td>优惠价格</td>
						<td>
							<input type="text" name="promotePrice" id="promotePrice" value="9.9" class="form-control">
						</td>
					</tr>
					<tr>
						<td>库存</td>
						<td>
							<input type="text" name="stock" id="stock" value="99" class="form-control">
						</td>
					</tr>
					<tr class="submitTR">
