...
<link href="css/fore/payedPage.css" rel="stylesheet">
...
<div class="payedDiv">
    ...
    <div class="payedAddressInfo">
        <ul>
            ...
            <li>实付款： <span class="payedInfoPrice">￥<fmt:formatNumber value="${order.total}" minFractionDigits="2" /></span></li>
            <li>预计08月08日送达</li>
        </ul>
        <div class="paydCheckLinkDiv">
			您可以
